...
function ModalResume({handleShow, selecData}) {
  return (
    <div id="exampleModal" aria-labelledby="exampleModalLabel" aria-hidden="false" style={{zIndex: "1", position: "absolute", top:20, left:66, width: "90%", height:"60%", backgroundColor: '#97afff', padding: 30, borderRadius: '12px'}}>
